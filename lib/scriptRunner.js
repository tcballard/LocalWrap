 ...
 *
 * This is the Electron-free core used by project lifecycle management so it can
 * be exercised by tests without a renderer. The caller supplies `onLine` and
 * `onExit` callbacks; the main process wires those to project events.
 *
 * @param {object}   opts
