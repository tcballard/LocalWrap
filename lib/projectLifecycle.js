  ...
  async start(project) {
    ...
    const state = {
      ...
      diagnosis: updateRuntimeDiagnosis(
        ...
        {
          status: 'checking',
          summary: 'Checking project before start.',
          timeline: {
            status: 'info',
    ...
    const onExit = (code) => {
      ...
      state.diagnosis = updateRuntimeDiagnosis(
        state.diagnosis,
        {
          ...
          summary: failed ? `Process exited with code ${code}.` : 'Project stopped.',
          check: {
            id: 'process',
    ...
    try {
      ...
      state.diagnosis = updateRuntimeDiagnosis(
        ...
        {
          status: 'starting',
          summary: 'Starting project command.',
          check: {
            id: 'process',
            status: 'running',
      ...
      state.diagnosis = updateRuntimeDiagnosis(
        ...
        {
          status: 'waiting',
          summary: 'Command started. Waiting for the app URL to respond.',
          check: {
            id: 'process',
            status: 'pass',
    ...
    try {
      ...
      if (!signal.aborted && state.child) {
        ...
        state.diagnosis = updateRuntimeDiagnosis(
          ...
          {
            status: 'attention',
            summary: 'Readiness check could not complete.',
            check: {
              id: 'readiness',
              status: 'warn',
              message: error.message,
